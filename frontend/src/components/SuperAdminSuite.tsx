...
export const SuperAdminSuite: React.FC = () => {
  const [activeSubTab, setActiveSubTab] = useState<'analytics' | 'tenants' | 'audit'>('analytics');
  ...
  return (
    <div className="bg-[#faf8ff] text-[#131b2e] min-h-screen flex flex-col font-body">
      ...
      <div className="bg-white border-b border-[#eaedff] px-4 py-2 flex items-center gap-2 shadow-xs">
        {[
          { id: 'analytics', label: 'Executive Analytics & GMV', icon: 'monitoring' },
          { id: 'tenants', label: 'Tenants & Shard Matrix', icon: 'hub' },
          { id: 'audit', label: 'SEC-18 Audit Ledger', icon: 'verified_user' }
        ].map((tab) => (
          <button
            key={tab.id}
      ...
      <div className="px-4 py-4 flex flex-col gap-4">
        ...
        {(activeSubTab === 'tenants' || activeSubTab === 'audit') && (
          <>
